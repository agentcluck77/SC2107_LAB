...
EUSCIA0.obj: C:/SC2107_FINAL/inc/EUSCIA0.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: "$<"'
	@echo 'Invoking: MSP432 Compiler'
...
FIFO0.obj: C:/SC2107_FINAL/inc/FIFO0.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: "$<"'
	@echo 'Invoking: MSP432 Compiler'
